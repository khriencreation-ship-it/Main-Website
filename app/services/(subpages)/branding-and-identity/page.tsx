...
const page = () => {
  ...
  return (
    <main className="px-4 lg:px-9 min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-brandYellow overflow-hidden max-w-360 mx-auto my-6 mt-[12vh] md:mt-[16vh] shadow-sm rounded-3xl flex flex-col justify-center items-center py-16 md:py-24 px-6 md:px-12">
        <motion.div
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-black/80 font-medium leading-relaxed max-w-3xl mx-auto">
            Strategy-led brand development focused on clarity, credibility, and consistency across digital platforms.
          </p>
        </motion.div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/90 leading-relaxed">
              A strong product without a clear identity struggles to gain trust, adoption, and loyalty. Branding aligns perception with purpose.
            </p>
          </motion.div>
      ...
      >
        ...
        <div className="flex flex-col items-center">
          <BrandButton
            ...
            button="Start a Branding Project"
            navigateTo="#"
