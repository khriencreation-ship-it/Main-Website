      ...
      <section className="relative overflow-hidden max-w-360 mx-auto my-6 mt-[14vh] md:mt-[16vh] shadow-sm rounded-3xl flex flex-col justify-center items-center py-16 md:py-24 px-6 md:px-12">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-white/80 font-medium leading-relaxed max-w-3xl mx-auto">
            Story-driven motion and video content designed to explain, promote, and engage.
          </p>
        </motion.div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/90 leading-relaxed">
              Motion simplifies complexity and communicates value faster than static content.
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center md:text-left">
          ...
          <p className="text-2xl md:text-4xl lg:text-5xl font-black text-black leading-tight border-l-0 md:border-l-8 border-brandPurple md:pl-10">
            Produced explainer content that improved product understanding and demo conversion rates.
          </p>
        </div>
      </motion.section>
