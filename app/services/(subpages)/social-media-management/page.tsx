...
const page = () => {
  ...
  return (
    <main className="px-4 lg:px-9 min-h-screen">
      {/* Hero Section */}
      <section className="relative overflow-hidden max-w-360 mx-auto my-6 mt-[13vh] md:mt-[16vh] shadow-sm rounded-3xl flex flex-col justify-center items-center py-16 md:py-24 px-6 md:px-12">
        <motion.div
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-white/80 font-medium leading-relaxed max-w-3xl mx-auto">
            Strategy-driven content planning and execution for brands building visibility and authority online.
          </p>
        </motion.div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-white/90 leading-relaxed">
              Social platforms are often the first point of contact. Structure and consistency determine credibility.
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center md:text-left">
          ...
          <p className="text-2xl md:text-4xl lg:text-5xl font-black text-black leading-tight border-l-0 md:border-l-8 border-brandPurple md:pl-10">
            Developed a structured content system that improved reach, engagement, and message clarity.
          </p>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="flex flex-col items-center">
          <BrandButton
            ...
            button="Start a Social Media Project"
            navigateTo="#"
